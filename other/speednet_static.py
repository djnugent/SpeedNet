...
class SpeedNet:
    ...
    def create_model(self):
        ...
        self.model.add(Convolution2D(3, 5,5 ,border_mode='same',input_shape=(self.DSIZE[0],self.DSIZE[1],3)))
        self.model.add(Activation('relu'))
        self.model.add(Convolution2D(24, 5,5 ,border_mode='same'))
        self.model.add(Activation('relu'))
        self.model.add(Convolution2D(36, 3,3 ,border_mode='same'))
        self.model.add(Activation('relu'))
        self.model.add(Convolution2D(48, 3,3,border_mode='same'))
        self.model.add(Activation('relu'))
        ...
        '''
        self.model = Sequential()
        self.model.add(Convolution2D(32, 8,8 ,border_mode='same', subsample=(4,4),input_shape=(self.DSIZE[0],self.DSIZE[1],3)))
        self.model.add(Activation('relu'))
    ...
    def train(self,X_src,Y_src,val_split, wipe,n_epochs = 50, batch_size= 32):
        #load data
        X,Y = self.prep_data(X_src,Y_src,shuffle = True)
